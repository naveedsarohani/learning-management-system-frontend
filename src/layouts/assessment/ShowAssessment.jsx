...
export default function ShowAssessment() {
  ...
  return handler.componentLoaded && <DashboardPageCompement title={"specified assessment"}>
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <div className="action">
            ...
            <ActionButton
              name={"Delete"}
              onClick={() => destroy("/assessments", assessment.id, "assessment", -1)}
          ...
          {!isNullOrEmpty(questions) ?
            questions.map((question) => (
              <AccordionContent
                ...
                noEdit={true}
                noView={true}
                currentTab={{ value: currentQuestionId, set: setCurrentQuestionId }}
                    ...
                    if (!isNullOrEmpty(currentAnswer)) {
                      return currentAnswer.question.type === "MCQ" ? (
                        <ul className="list-none text-gray-700">
                          {populateOptions(currentAnswer.answer_text, false)}
