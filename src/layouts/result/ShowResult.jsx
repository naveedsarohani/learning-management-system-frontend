...
import { capEach, capitalize, formatDate } from "../../uitils/functions/global"
...
export default function ShowResult() {
  ...
  return handler.componentLoaded && <DashboardPageCompement title={"specified result"} >
    <div className="max-w-4xl mx-auto px-6 py-8 bg-white shadow-lg rounded-lg">
      ...
      <div className="mt-6">
        <ActionButton
          name="Delete"
          onClick={() => destroy("/exam-submissions", result.id, "result", -1)}
