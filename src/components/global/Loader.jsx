...
const Loader = () => {
  return (
    <div className="relative">
      ...
      <div className="fixed inset-0 bg-gray-500 bg-opacity-60  z-40"></div>

      {/* Loader */}
      <div className="flex absolute items-center justify-center top-[10%] left-[10%] rounded-full z-50">
        <svg
